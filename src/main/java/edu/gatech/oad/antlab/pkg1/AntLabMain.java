 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Alana Lin");
		  toPrint += p1.toString("alin40");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Daniel Gonzalez");
		  toPrint += p2.toString("dgonzalez37");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("John Murphy");
		  toPrint += p3.toString("jmurphy46");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Michael Hartle");
          toPrint += p4.toString("mhartle3");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("James Mullenbach");
          toPrint += p5.toString("jmullenbach3");
